...
class GeocodeApiWrapper(ContextDecorator):
    '''
    Context managed API Wrapper that provides interaction with Google's Geocode API.
    ...
    def get_geocode(self, query: Dict[str, str]):
        ...
        -----------
        query: Dict[str, str]
            Keys correspond to available keys from Geocode API
