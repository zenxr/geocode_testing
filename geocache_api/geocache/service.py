...
from geocache_api.geocache.geocache_classes import GeoCacheApiWrapper, LatLongCoordinate
from geocache_api.users.models import User

EARTH_RADIUS_MILES = 3959.87433
EARTH_RADIUS_KILOMETERS = 6372.8

class InvalidGeoCacheApiResponse(Exception):
    pass
...
def search_address(address: str):
    ...
    with GeoCacheApiWrapper() as geo_api:
        ...
        try:
            ...
            raise InvalidGeoCacheApiResponse('Google Geocache API response format did not match expected')
